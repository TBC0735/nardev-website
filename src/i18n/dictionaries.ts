...
const en: Dict = {
  ...
  legal: {
    ...
    dataRights:
      "Your rights: under Senegalese law no. 2008-12 of 25 January 2008 on personal data protection, you have a right of access, rectification and deletion of your data. Write to nardev.contact@yahoo.com. You may also contact Senegal's Personal Data Protection Commission (CDP).",
    cookiesTitle: "Cookies",
    cookiesBody:
